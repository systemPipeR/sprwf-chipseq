## ChIP-Seq Workflow Template for systemPipeR WMS
...
Detailed information about this specific `sprwf-chipseq` workflow is available 
[here](https://systempipe.org/sprwf-chipseq/systemPipeChIPseq.html).
...
genWorkenvir_gh(url = "https://github.com/systemPipeR/sprwf-chipseq.git", mydirname = "sprwf-chipseq")
setwd("sprwf-chipseq")
getParam_gh()
